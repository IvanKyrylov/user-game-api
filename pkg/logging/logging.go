...
func Init() *log.Logger {
	...
	// 	}
	CommonLog = log.New(os.Stdout, "Common Logger:\t", log.Ldate|log.Ltime|log.Lshortfile)
	ErrorLog = log.New(os.Stdout, "Error Logger:\t", log.Ldate|log.Ltime|log.Lshortfile)
